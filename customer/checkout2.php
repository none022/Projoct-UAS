...
if (empty($_SESSION['username'])){
	...
	include "../conn.php";
        ...
        if ($query1 and $input) {
                    ...
                    echo "<script>alert('Checkout Sukses, silahkan cetak invoice dan lakukan pembayaran..'); window.location = 'home.php'</script>";
                
            } else {
                echo "<script>alert('Checkout Gagal !'); window.location = 'home.php'</script>";
